...
import com.example.administrator.traing.adapter.TabHomeAdapter;
...
public class ChoicePager extends MenuDetailBasePage {
    @ViewInject(R.id.rv)
    ...
    private TabHomeAdapter tabCommonAdapter;

    private List<Common.DataBean.ListBean> list;
    private View mRootView;

    public ChoicePager(Context context) {
        super(context);
    }
    ...
    public View initView() {
        ...
        x.view().inject(ChoicePager.this, mRootView);
    ...
    public void initData() {
        ...
        String cacheJson = CacheUtils.getString(context, Constants.NEWS_EXPLORE_CHOICE);
    ...
    private void getMoreData() {
        index++;
        RequestParams p2 = new RequestParams(Constants.NEWS_EXPLORE_CHOICE + "&offset=" + index);
    ...
    private void getDataFromNet() {
        RequestParams param = new RequestParams(Constants.NEWS_EXPLORE_CHOICE);
        x.http().get(param, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                //CACHE DATA
                CacheUtils.putString(context, Constants.NEWS_EXPLORE_CHOICE, result);
    ...
    private void processData(String result) {
        ...
        if (!isLoadMore) {
            ...
            tabCommonAdapter = new TabHomeAdapter(context, list);
