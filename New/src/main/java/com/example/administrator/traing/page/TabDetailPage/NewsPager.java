...
public class NewsPager extends MenuDetailBasePage {
    @ViewInject(R.id.rv)
    ...
    public View initView() {
        ...
        x.view().inject(NewsPager.this, mRootView);
    ...
    public void initData() {
        ...
        String cacheJson = CacheUtils.getString(context, Constants.NEWS_EXPLORE_NEWS);
    ...
    private void getDataFromNet() {
        RequestParams param = new RequestParams(Constants.NEWS_EXPLORE_NEWS);
        x.http().get(param, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                //CACHE DATA
                CacheUtils.putString(context, Constants.NEWS_EXPLORE_NEWS, result);
    ...
    private void getMoreData() {
        index++;
        RequestParams p2 = new RequestParams(Constants.NEWS_EXPLORE_NEWS + "&offset=" + index);
