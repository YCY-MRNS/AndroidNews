...
public class TechnologyPager extends MenuDetailBasePage {
    ...
    public View initView() {
        ...
        x.view().inject(TechnologyPager.this, mRootView);
    ...
    public void initData() {
        ...
        String cacheJson = CacheUtils.getString(context, Constants.NEWS_EXPLORE_TEC);
    ...
    private void getDataFromNet() {
        RequestParams param = new RequestParams(Constants.NEWS_EXPLORE_TEC);
        x.http().get(param, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                //CACHE DATA
                CacheUtils.putString(context, Constants.NEWS_EXPLORE_TEC, result);
    ...
    private void getMoreData() {
        index++;
        RequestParams p2 = new RequestParams(Constants.NEWS_EXPLORE_TEC + "&offset=" + index);
