...
public class ArtPager extends MenuDetailBasePage {
    @BindView(R.id.rv)
    RefreshListView mLV;
    ...
    public ArtPager(Context context) {
        super(context);
    }
    ...
    public View initView() {
        ...
        ButterKnife.bind(ArtPager.this, mRootView);
    ...
    public void initData() {
        ...
        String cacheJson = CacheUtils.getString(context, Constants.NEWS_EXPLORE_ART);
    ...
    private void getDataFromNet() {
        RequestParams param = new RequestParams(Constants.NEWS_EXPLORE_ART);
        x.http().get(param, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                //CACHE DATA
                CacheUtils.putString(context, Constants.NEWS_EXPLORE_ART, result);
    ...
    private void getMoreData() {
        ...
        RequestParams p2 = new RequestParams(Constants.NEWS_EXPLORE_ART + "&offset=" + index);
