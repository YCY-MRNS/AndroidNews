...
public class VideoPager extends MenuDetailBasePage {
    @ViewInject(R.id.rv)
    ...
    public View initView() {
        ...
        x.view().inject(VideoPager.this, mRootView);
    ...
    public void initData() {
        ...
        String cacheJson = CacheUtils.getString(context, Constants.NEWS_EXPLORE_VIDEO);
    ...
    private void getDataFromNet() {
        RequestParams param = new RequestParams(Constants.NEWS_EXPLORE_VIDEO);
        x.http().get(param, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                //CACHE DATA
                CacheUtils.putString(context, Constants.NEWS_EXPLORE_VIDEO, result);
    ...
    private void getMoreData() {
        index++;
        RequestParams p2 = new RequestParams(Constants.NEWS_EXPLORE_VIDEO + "&offset=" + index);
